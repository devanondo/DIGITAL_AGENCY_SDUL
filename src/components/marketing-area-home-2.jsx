...
const MarketingAreaHome2 = () => {
    return (
        <section className="marketing-area-home-2">
            <img
                src={asset.bg_blur_shep_2}
                alt="VRE"
                className="marketing-area-bg-shep-home-2 blur-1"
            />
...
export default MarketingAreaHome2
